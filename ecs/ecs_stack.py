...
class EcsStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        taskRole=iam.Role(self,id="taskRole",assumed_by=iam.CompositePrincipal(iam.ServicePrincipal(service='ecs-tasks.amazonaws.com'),iam.ServicePrincipal(service='ec2.amazonaws.com')),role_name="webmaintaskRole"
        ...
        listener = webmain_lb.add_listener("webMain_Listener",
                                   ...
                                   certificate_arns=["arn:aws:acm:us-west-2:384853870836:certificate/182c0fdd-813f-4bd3-aee1-0b4543cfb52b"]
                                   )
